...
Para la concepción, análisis, diseño y especificación formal del artefacto *Arquitectura Genérica* se implementó un marco metodológico estructurado de naturaleza híbrida. Este combina los principios ágiles del marco de trabajo *Scrum* para la gestión y coordinación del equipo con el rigor analítico de la *Ingeniería de Requisitos* con la herramienta Jira y la disciplina de modelado arquitectónico basada en la descomposición de responsabilidades y la trazabilidad de requisitos.
