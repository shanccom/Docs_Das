...
El presente artefacto tiene como propósito formalizar la especificación, el modelado y la documentación de la Arquitectura Genérica correspondiente al sistema clínico OmVital Physio Control. Dicho sistema ha sido concebido para dar soporte a una red de clínicas especializadas en fisioterapia y rehabilitación física ambulatoria, garantizando una atención clínica segura, una orquestación eficiente de los recursos y una trazabilidad médico-legal en sus diferentes sedes.

La arquitectura genérica establece una representación estructurada de los componentes que conformarán el sistema y de las relaciones entre ellos, sirviendo de base para las decisiones posteriores de diseño y construcción del software. A través de un nivel adecuado de abstracción, se organizan las responsabilidades del sistema sin introducir dependencias tecnológicas, lenguajes de programación o plataformas específicas.
...
1. Gestión de pacientes y expedientes clínicos: Registro de nuevos usuarios, apertura de historias clínicas, captura digital de consentimientos informados con respaldo legal inalterable y actualización permanente de antecedentes de salud, bajo la premisa de prohibir el borrado físico para salvaguardar la responsabilidad médico-legal institucional.
...
1. Delimitar el alcance funcional y las fronteras del sistema: Representar la interacción de los actores (`ACT-0001` FisioTerapeuta, `ACT-0002` Coordinador, `ACT-0003` Recepcionista, `ACT-0004` Gerente y Paciente) con los límites del software y los servicios externos a través de una vista de contexto clara.
