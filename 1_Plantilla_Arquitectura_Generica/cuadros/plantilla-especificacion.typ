...
#let plantilla_especificacion(
  ...
  color_encabezado: rgb("#ffe599"), // Amarillo Google Docs
  ...
  ancho_columna_2: 1fr,             // Ancho restante maximizado para pseudocódigo
  ...
  let cod = named.at("codigo-especificacion", default: named.at("codigo_especificacion", default: named.at("codigo", default: codigo)))
...
#let plantilla-especificacion = plantilla_especificacion
