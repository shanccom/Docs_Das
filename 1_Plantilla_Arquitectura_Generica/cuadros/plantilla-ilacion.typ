...
#let plantilla_ilacion(
  ...
  codigo_educcion: "EDU-DDDD",
  codigo_especificacion: "ESP-DDDD",
  precondicion: "Definir la precondiciones",
  procedimiento: "Descripción del procedimiento",
  postcondicion: "Definir las postcondiciones",
  codigo_artefactos_asociados: "ART-DDDD (ver nemónicos)",
  ...
  color_encabezado: rgb("#cfe2f3"), // Azul Google Docs
  color_texto_encabezado: black,
  ancho_tabla: 100%,                // Ancho completo aprovechando los márgenes
  ancho_columna_1: 4.2cm,           // Ancho adecuado para los nombres de campos
  ancho_columna_2: 1fr,             // Ancho restante para los valores
  alineacion: (left + top, left + top),
  inset: (x: 7pt, y: 5pt),
  stroke: 0.5pt + luma(140),
  tamano_letra: 9.5pt,              // Tamaño de letra óptimo
  ..args,
) = {
  let named = args.named()
  let cod = named.at("codigo-ilacion", default: named.at("codigo_ilacion", default: codigo))
  ...
  let edu = named.at("codigo-educcion", default: named.at("codigo_educcion", default: named.at("educcion", default: codigo_educcion)))
  let esp = named.at("codigo-especificacion", default: named.at("codigo_especificacion", default: named.at("especificacion", default: codigo_especificacion)))
  let pre = named.at("precondicion", default: named.at("precondiciones", default: precondicion))
  let pro = named.at("procedimiento", default: procedimiento)
  let pos = named.at("postcondicion", default: named.at("postcondiciones", default: named.at("poscondicion", default: postcondicion)))
  let art = named.at("codigo-artefactos-asociados", default: named.at("codigo_artefactos_asociados", default: named.at("artefactos_asociados", default: named.at("artefactos-asociados", default: codigo_artefactos_asociados))))
      ...
      #table(
        ...
        table.header(
          table.cell(fill: col_enc, align: left + horizon)[
            #text(fill: col_txt, weight: "bold")[Código ilación]
          ],
          table.cell(fill: col_enc, align: left + horizon)[
        ...
        [*Experto*], [#exp],
        [*Código educción*], [#edu],
        [*Código especificación*], [#esp],
        [*Precondición*], [#pre],
        [*Procedimiento*], [#pro],
        [*Postcondición*], [#pos],
        [*Código de artefactos asociados*], [#art],
        [*Importancia*], [#imp],
        [*Estado*], [#est],
        [*Comentario*], [#com],
      )
...
#let plantilla-ilacion = plantilla_ilacion
