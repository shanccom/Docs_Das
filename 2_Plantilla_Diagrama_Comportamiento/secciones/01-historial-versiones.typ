...
#table(
  ...
  [22 / 09 / 2026], [Corrección de observaciones del docente: se especificaron las cantidades exactas de concurrencia, retraso, afluencia de pacientes y número de intentos en las secciones de conclusiones y observaciones.], [2.0.0], [Ninguno], [Aprobado],
)
